...
export const common = {
  ...
  "footer.identity": "Portfolio of Daren, developer and creator of HEDNAI — digital solutions built with the real world in mind.",
  "footer.identity.recruiter": "Daren — developer, seafarer and creator of HEDNAI. I build digital solutions with a hands-on understanding of the field.",
