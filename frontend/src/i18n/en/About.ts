...
export const about = {
  ...
  "roadmap.m2.desc": "Building the first technical foundations: Express, PostgreSQL, Redis, testing and CI/CD. Hands-on practice through Full Stack projects that lay the groundwork for Hednai's future solutions.",
  "roadmap.m3.title": "AI specialization",
  "roadmap.m3.desc": "Artificial Intelligence Software Development program at Algonquin College. Deepening AI knowledge to progressively explore its integration into Hednai's future projects and solutions.",
  "roadmap.m4.title": "Maritime digital solutions",
  "roadmap.m4.desc": "From smart ports to fleet management, port operations to crew tracking, route optimization to predictive maintenance: exploring, designing and building digital solutions to address the realities of the sector.",
  "roadmap.m5.title": "International expansion",
  "roadmap.m5.desc": "Building digital solutions from Canada to address maritime realities around the world.",
};