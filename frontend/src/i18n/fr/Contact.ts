...
export const contact = {
  ...
  "contact.form.subject.maritime": "Application maritime",
  "contact.form.subject.port": "Solution portuaire",
  "contact.form.subject.webmobile": "Projet web ou mobile",
  "contact.form.subject.ai": "IA et données",
